...
export class CrashLayer extends BaseLayer {
    ...
    createBg(resource) {
        this.spr_bg = this.createSprite(resource.bg, gameApp.canvas_width / 2, gameApp.canvas_height / 2, 0.5, 0.5, gameApp.max_scale * 0.8);
    ...
    renderBg() {
        ...
        this.spr_bg.scale.set(gameApp.max_scale * 0.8);
    }
